    ...
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 pb-24">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:items-start">
          <div className={cn('min-w-0', tab !== 'globe' && 'hidden md:block')}>
            <section
              aria-label="Globe"
              className="rounded-2xl border border-grey-200 bg-white p-4 dark:border-grey-800 dark:bg-grey-900"
            >
              <Globe />
            </section>
            <footer className="mt-3 px-1 text-xs text-grey-400 dark:text-grey-600">
              2026 · Built by{' '}
              <a
